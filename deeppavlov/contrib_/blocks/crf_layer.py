...
<<<<<<< HEAD
    raise ImportError('crf_decode was removed from tf.contrib')
...
<<<<<<< HEAD
    ...
    def viterbi_decode(self, potentials, sequence_length):
        """
        Decode the highest scoring sequence of tags in TensorFlow. This is a function for tensor.
...
>>>>>>> origin/feature/contrib
        ...
        Returns:
<<<<<<< HEAD
            decode_tags: A [batch_size, max_seq_len] tensor (dtype tf.int32) with the highest scoring tag indicies.
=======
            decode_tags: A [batch_size, max_seq_len] tensor, with dtype tf.int32.
                         Contains the highest scoring tag indicies.
>>>>>>> origin/feature/contrib
...
<<<<<<< HEAD
        ...
        return K.in_train_phase(features, y_pred_one_hot)
